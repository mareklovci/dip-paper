...
\begin{table}[htbp]
    ...
    \begin{tabular}{llll}
        \toprule
        Dimension                           & Characteristics               & Score & Final Score           \\ \midrule
        \multirow{2}{*}{Relevance}          & Adaptability                  & 2.0   & marginal (2)          \\
                                            & Value                         & 1.5   & marginal (2)          \\ \midrule
        \multirow{13}{*}{Accuracy}          & Form Design and Completion    & 1.5   & marginal (2)          \\
                                            & Frame                         & 3.0   & appropriate (3)       \\
                                            & Over Coverage                 & 0.0   & unknown (0)           \\
                                            & Under Coverage                & 1.0   & not acceptable (1)    \\
                                            & Response                      & 2.5   & appropriate (3)       \\
                                            & Completeness                  & 0.0   & unknown (0)           \\
                                            & Bias                          & 0.33  & unknown (0)           \\
                                            & Validity                      & 1.25  & not acceptable (1)    \\
                                            & Reliability                   & 0.67  & not acceptable (1)    \\
                                            & Collection                    & 1.5   & marginal (2)          \\
                                            & Processing                    & 0.5   & not acceptable (1)    \\
                                            & Imputation                    & 1.5   & marginal (2)          \\
                                            & Analysis                      & 0.5   & not acceptable (1)    \\ \midrule
        \multirow{2}{*}{Timeliness}         & Data Currency                 & 3.0   & appropriate (3)       \\
                                            & System Efficiency             & 0.0   & unknown (0)           \\ \midrule
        \multirow{2}{*}{Accessibility}      & Awareness                     & 3.0   & appropriate (3)       \\
                                            & Ease of Access                & 3.0   & appropriate (3)       \\ \midrule
        \multirow{2}{*}{Interpretability}   & Documentation                 & 2.5   & appropriate (3)       \\
                                            & Education                     & 2.5   & appropriate (3)       \\ \midrule
        \multirow{3}{*}{Coherence}          & Standardization               & 2.0   & marginal (2)          \\
                                            & Linkage                       & 3.0   & appropriate (3)       \\
                                            & Historical Comparability      & 2.5   & appropriate (3)       \\
...
\begin{table}[htbp]
    ...
    \begin{tabular}{lll}
        \toprule
        Dimension                           & Total Score   \\ \midrule
        \multirow{2}{*}{Relevance}          & 1.75          \\
        \multirow{13}{*}{Accuracy}          & 1.1           \\
        \multirow{2}{*}{Timeliness}         & 1.5           \\
        \multirow{2}{*}{Accessibility}      & 3.0           \\
        \multirow{2}{*}{Interpretability}   & 2.5           \\
        \multirow{3}{*}{Coherence}          & 2.5           \\
